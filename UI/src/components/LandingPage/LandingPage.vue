      ...
      <div class="float-container">
        ...
        <div class="col-12 col-md-8 col-lg-6 col-xl-12">
                <div class="form-floating mb-3">
                  <input type="chol" class="form-control" id="floatingInput" placeholder="e.g. 21">
                  <label for="floatingInput">Cholesterol Level in mg/dl</label>
                </div>
                <div class="form-floating mb-3">
                  <input type="fbs" class="form-control" id="floatingInput" placeholder="Male or Female">
                  <label for="floatingInput">Fasting Blood Sugar in mg/dl</label>
                </div>
                <div class="form-floating mb-3">
                  <input type="restcg" class="form-control" id="floatingInput" placeholder="e.g. 145">
        ...
        <div class="col-12 col-md-8 col-lg-6 col-xl-12">
                <div class="form-floating mb-3">
                  <input type="thalach" class="form-control" id="floatingInput" placeholder="Yes or No">
                  <label for="floatingInput">Maximum Heart Rate</label>
                </div>
                <div class="form-floating mb-3">
                  <input type="thal" class="form-control" id="floatingInput" placeholder="e.g. 2">
